...
Public Class crpProductQ
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Train61VB2N3.crpProductQ.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_CompanyAdress() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedcrpProductQ
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpProductQ = New crpProductQ()
        rpt.Site = Me.Site
        Return rpt
    End Function
